...
const bool WASM_DEBUG_POINTERS = WASM_DEBUG_ALL || (WASM_DEBUG && true);
const bool WASM_DEBUG_POINTERS_BACKTRACE = WASM_DEBUG_ALL || (WASM_DEBUG && true);
const bool WASM_DEBUG_POINTERS_IGNORE_OUTSIDE_HEAP = WASM_DEBUG_ALL || (WASM_DEBUG && true); 
...
const bool WASM_DEBUG_SAFE_TAG = WASM_DEBUG_ALL || (WASM_DEBUG && true);

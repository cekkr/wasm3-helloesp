...
const bool WASM_DEBUG_PARSE = WASM_DEBUG_ALL || (WASM_DEBUG && false);
...
const bool WASM_DEBUG_PARSETYPE_MEMORY = WASM_DEBUG_ALL || (WASM_DEBUG && false);
...
const bool WASM_DEBUG_ParseSection_Function = WASM_DEBUG_ALL || (WASM_DEBUG && false);
...
const bool WASM_DEBUG_PARSE_SECTION = WASM_DEBUG_ALL || (WASM_DEBUG && false);
...
const bool WASM_DEBUG_PARSESECTION_MEMORY = WASM_DEBUG_ALL || (WASM_DEBUG && false);
...
const bool WASM_DEBUG_PARSE_MODULE = WASM_DEBUG_ALL || (WASM_DEBUG && false);

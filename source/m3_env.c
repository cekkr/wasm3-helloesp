...
static const bool WASM_DEBUG_NEW_ENV = WASM_DEBUG && false;
...
static const bool WASM_DEBUG_ADDFUNC = WASM_DEBUG && false;
...
const bool WASM_DEBUG_RemoveCodePageOfCapacity = WASM_DEBUG && true;
...
static const bool WASM_DEBUG_STACK = WASM_DEBUG && false;
...
const bool WASM_DEBUG_NEW_RUNTIME = WASM_DEBUG && true;
...
const bool WASM_DEBUG_EvaluateExpression = WASM_DEBUG && true;
...
const bool WASM_DEBUG_ResizeMemory = WASM_DEBUG && true;
...
const bool WASM_DEBUG_INIT_MEMORY = WASM_DEBUG && true;
...
const bool WASM_DEBUG_InitGlobals = WASM_DEBUG && true;
...
const bool WASM_DEBUG_INIT_DATA_SEGMENTS = WASM_DEBUG && true;
...
const bool WASM_DEBUG_INIT_ELEMENTS = WASM_DEBUG && true;
...
static const bool WASM_DEBUG_VERBOSE_v_FindFunction = WASM_DEBUG && false;
...
const bool WASM_DEBUG_AcquireCodePageWithCapacity = WASM_DEBUG && true;

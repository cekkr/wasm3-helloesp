...
const bool WASM_DEBUG_FUNCTION_RELEASE = WASM_DEBUG_ALL || (WASM_DEBUG && true);
...
const bool WASM_DEBUG_PARSE_FUNCTION_SIGNATURE = WASM_DEBUG_ALL || (WASM_DEBUG && true);
...
const bool WASM_DEBUG_ADD_FUNCTION_NAME = WASM_DEBUG_ALL || (WASM_DEBUG && true);
